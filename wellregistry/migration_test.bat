...
SET DATABASE_PASSWORD=changeMe
SET DATABASE_HOST=localhost
SET DATABASE_PORT=5432

SET APP_DATABASE_NAME=well_registry
SET APP_DB_OWNER_USERNAME=well_registry_owner
SET APP_DB_OWNER_PASSWORD=appOwnerChangeme

SET APP_SCHEMA_NAME=registry
SET APP_SCHEMA_OWNER_USERNAME=registry_owner
SET APP_SCHEMA_OWNER_PASSWORD=registryOwnerChangeme
