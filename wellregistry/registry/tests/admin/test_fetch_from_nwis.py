...
class TestFetchFromNwisView(TestCase):
    FETCH_URL = '/apps/location-registry/admin/registry/monitoringlocation/fetch_from_nwis/'
    ...
    def test_post_with_new_site_no(self, mock_request):
        ...
        self.assertRedirects(resp, f'/apps/location-registry/admin/registry/monitoringlocation/{monitoring_location.id}/change/')
    ...
    def test_post_with_no_overwrite(self, mock_request):
        ...
        self.assertRedirects(resp2, f'/apps/location-registry/admin/registry/monitoringlocation/{monitoring_location.id}/change/')
