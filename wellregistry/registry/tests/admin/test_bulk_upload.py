...
class TestBulkUploadView(TestCase):
    URL = '/apps/location-registry/admin/registry/monitoringlocation/bulk_upload/'
    ...
    def test_post_with_no_file_selected(self):
        resp = self.view.post(self.view.request)
        self.assertEqual(resp.status_code, 200)
        self.assertIn('Please select a file to upload', resp.content.decode())
...
class TestBulkUploadTemplateView(TestCase):
    ...
    def test_get_template(self):
        ...
        response = client.get('/apps/location-registry/admin/registry/monitoringlocation/bulk_upload_template/')
