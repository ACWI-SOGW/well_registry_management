...
class TestBasePage(TestCase):
    ...
    def test_base_page(self):
        req = self.factory.get('/apps/location-registry')
...
class TestMonitoringLocationsListView(TestCase):
    ...
    def test_all_monitoring_locations(self):
        req = self.factory.get('/apps/location-registry/monitoring-locations/?format=json')
    ...
    def test_display_flag_true_monitoring_locations(self):
        req = self.factory.get('/apps/location-registry/monitoring-locations/?format=json&display_flag=true')
        resp = MonitoringLocationsListView.as_view()(req)
    ...
    def test_display_flag_false_monitoring_locations(self):
        req = self.factory.get('/apps/location-registry/monitoring-locations/?format=json&display_flag=false')
        resp = MonitoringLocationsListView.as_view()(req)
...
class TestStatusCheck(TestCase):
    ...
    def test_base_page(self):
        # TEST ACTION
        req = self.factory.get('/apps/location-registry/status')
