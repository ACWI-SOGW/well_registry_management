...
def load_country_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/country.csv'
...
def load_state_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/state.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_county_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/county.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_national_aquifer_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/nat_aqfr.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_altitude_datum_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/altitude_datums.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_horizontal_datum_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/horizontal_datums.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_unit_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/units.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
...
def load_agency_lookups(apps, schema_editor):
    ...
    data_src = 'wellregistry/registry/migrations/initial_data/agency.csv'
    with default_storage.open(data_src, 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        next(csvreader)
